Naona is a peer-to-peer video chat application with chat features as well. 'Naona', meaning 'I see' in Swahili is built on a JavaScript(ES6) event and promise-driven backbone.
